...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  {
    id: 5,
    question: '2025년 국세청에서 무료로 세금 환급해주는 서비스가 있다?',
    type: 'ox',
    correctAnswer: 'O',
    score: 20,
    explanation: '맞아요! 국세청 "원클릭" 서비스가 2025년 3월부터 시작됐어요. 최대 5년치 환급금을 무료로 확인하고 신청할 수 있어요. 삼쩜삼 같은 민간 서비스는 수수료가 있지만, 원클릭은 완전 무료예요!',
    tip: '💡 홈택스에서 "원클릭 환급 신고" 메뉴를 찾아보세요. 클릭 한 번으로 최대 5년치 환급금을 확인할 수 있어요. 하지만 미리 계산기로 예상 세액을 확인하면 더 확실해요!',
  },
];
